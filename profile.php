	...
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
				$delete = mysqli_query($con, "DELETE FROM empleados WHERE codigo='$codigo'");
				if($delete){
			...
			<a href="edit.php?nik='.$row['codigo'].'" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar datos</a>
